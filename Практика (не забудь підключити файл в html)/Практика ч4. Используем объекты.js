...
const personalMovieDB = {
   ...
   toggleVisibleMyDB: function () {  //Створюємо класичний перемикач, тоглер ЗАДАЧА №2
   ...
   writeYourGenres: function () {
      for (let i = 1; i <= 2; i++) {
         //Нижче закоментований перший варіант вирішення задачі
         ...
         personalMovieDB.genres.forEach((item, i) => {  //item - це назва елемента, а і- це його номер по порядку
